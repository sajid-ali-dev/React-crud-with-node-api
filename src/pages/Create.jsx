        ...
        <div className="max-w-lg  bg-white shadow-lg mx-auto p-7 rounded mt-6">
            ...
            <form onSubmit={saveProduct}>
                <div className="space-y-2">
                    ...
                    <div>
                        <button disabled={isLoading} className="block w-full mt-6 bg-blue-700 text-white rounded-sm px-4 py-2 font-bold hover:bg-blue-600 hover:cursor-pointer">Save</button>
                    </div>
                </div>
            </form>
